package com.yxkj.kzzx.ui.widget;
...
public class MyAudioPlayer implements IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnPreparedListener
    ...
    public MyAudioPlayer(String voice_url, SeekBar seekBar) {
        mSeekbar = seekBar;
